...
export class BadgeComponent implements OnChanges {
  ...
  constructor() {
    ...
    this.badgeClass = 'inline-flex items-center px-2 py-1 body-xs bg-primary-100 font-semibold text-primary-500';
  }
  ...
  setColorBadge(color = ''): void {
    const badgeClassAux: IBadgeClass = {
      primary: 'inline-flex items-center py-1 px-2 body-xs font-semibold bg-primary-100 text-primary-500',
      success: 'inline-flex items-center py-1 px-2 body-xs font-semibold bg-success-50 text-success-200',
      warning: 'inline-flex items-center py-1 px-2 body-xs font-semibold bg-warning-50 text-warning-200',
      ...
      neutral: 'inline-flex items-center py-1 px-2 font-semibold body-xs bg-neutral-300 text-neutral-1000'
    };
